describe("hacktrade", function()
  ...
  describe("для объекта MarketData", function()
    ...
    describe("при непустом стакане", function()
      ...
      it("по прочим ключам запрос адресуетс в getParamEx", function()
    ...
    describe("при пустом стакане", function()
      ...
      pending("по ключу bids отдается nil", function()
        assert.is_nil(feed.bids)
      end)

      pending("по ключу offers отдается nil", function()
        assert.is_nil(feed.offers)
      end)

      pending("по прочим ключам отдается nil", function()
