...
Разработчикам
-------------
Автотесты написаны с помощью [busted](https://olivinelabs.com/busted/), для которого есть хорошая документация и подробно описан процесс [установки](https://olivinelabs.com/busted/#usage). Запускаются они следующим образом:
